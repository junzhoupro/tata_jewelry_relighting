...
if __name__ == '__main__':
    ...
    parser.add_argument("--output_dir", type=str, default="./preprocessed_lighting_data",
                        help="path to the folder containing environment maps")
    ...
    parser.add_argument("--init_RT_path", type=str, default="./demo/default_pose.npy",
                        help="path to the folder containing environment maps")
    ...
    for light_idx in range(to_process_light_num):
        ...
        for frame_idx in tqdm(range(args.frame_num)):
            ...
            envir_map_ldr, envir_map_hdr = rotate_and_preprcess_envir_map(envir_map_hdr_values[envir_map_name], init_RT,
                                                                          rotation_idx=frame_idx,
                                                                          total_view=args.frame_num)
