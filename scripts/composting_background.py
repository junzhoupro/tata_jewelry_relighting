...
if __name__ == "__main__":
    ...
    # parser.add_argument('--original_dir', type=str, default="./demo", help='Path to the original image directory')
    ...
    for object in tqdm(object_list):
        ...
        for lighting in lighting_list:
            ...
            if os.path.isdir(action_dir):
                ...
                imageio.mimsave(cur_video_save_dir, images, fps=24, quality=10)
                import imageio
                ...
                #     images,
                #     fps=30,
                #     codec="libx264rgb",  # Preserves colors exactly
                #     ffmpeg_params=["-crf", "0", "-preset", "veryslow", "-pix_fmt", "rgb24"]
                # )
                # imageio.mimsave(
                #     cur_video_save_dir,
                #     images,
                #     fps=30,
                #     codec="ffv1",  # 100% lossless format
                #     ffmpeg_params=["-level", "3"]
                # )
