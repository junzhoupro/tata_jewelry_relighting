...
class NeuralGafferTrainingData(Dataset):
    ...
    def __getitem__(self, index):
        ...
        if self.validation:
            ...
            lighting_idx_cond, lighting_idx_target, lighting_idx_another_target = random.sample(range(total_lighting),
                                                                                                3)  # without replacement, return unique values
...
if __name__ == "__main__":
    ...
    dataloader = NeuralGafferTrainingDataLoader(
        ...
        lighting_dir_train=f'/home/jz927/Documents/relighting/neuralgaffer/training_lighting_data_subset',
        # img_dir_train='/scratch/datasets/hj453/objaverse-rendering/filtered_V2/rendered_images_resized',
        img_dir_train='/home/jz927/Documents/relighting/neuralgaffer/training_img_data_subset',
